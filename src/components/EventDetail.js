  ...
  return (
    <Modal isVisible={isVisible} onBackdropPress={onClose} style={styles.modal}>
      <View style={[styles.container, darkMode && styles.containerDark]}>
        ...
        <Text style={[styles.title, styles.bold, darkMode && styles.boldDark]}>Location:</Text>
        ...
        <View>
          <Text style={[styles.title, styles.bold, darkMode && styles.boldDark]}>Date:</Text>
          <Text style={[styles.text, darkMode && styles.textDark]}>{dateFormatter(event.date)}</Text>
        </View>
        <Text style={[styles.title, styles.bold, darkMode && styles.boldDark]}>Provider:</Text>
        <Text style={[styles.text, darkMode && styles.textDark]}>{event.provider}</Text>

        <Text style={[styles.title, styles.bold, darkMode && styles.boldDark]}>Coupon:</Text>
